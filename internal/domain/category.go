...
// CategoryType represents the type of category group (income or expense)
...
type Category struct {
	...
	ArchivedAt          *time.Time `json:"archived_at,omitempty"`                    // If set, category is archived (soft deleted)
