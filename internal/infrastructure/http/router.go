...
func NewRouter(
	...
	mux.HandleFunc("GET /api/transfer-suggestions/pending", transferSuggestionHandler.ListPendingSuggestions)
	mux.HandleFunc("GET /api/transfer-suggestions", transferSuggestionHandler.ListAllSuggestions)
