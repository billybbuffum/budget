...
func (h *CategoryHandler) CreateCategory(w http.ResponseWriter, r *http.Request) {
	...
	category, err := h.categoryService.CreateCategory(r.Context(), req.Name, req.Type, req.Description, req.Color)
	if err != nil {
...
func (h *CategoryHandler) ListCategories(w http.ResponseWriter, r *http.Request) {
	...
	if categoryType != "" {
		categories, err = h.categoryService.ListCategoriesByType(r.Context(), domain.CategoryType(categoryType))
	} else {
...
func (h *CategoryHandler) UpdateCategory(w http.ResponseWriter, r *http.Request) {
	...
	category, err := h.categoryService.UpdateCategory(r.Context(), id, req.Name, req.Type, req.Description, req.Color)
	if err != nil {
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
